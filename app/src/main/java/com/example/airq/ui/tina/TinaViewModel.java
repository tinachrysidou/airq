...
public class TinaViewModel extends ViewModel {
    ...
    public TinaViewModel() {
        ...
        url.setValue("https://grafana.airq.tech/d/cxkEBdtGk/tina-mobile?orgId=1&refresh=5s&from=now-1h&to=now&kiosk&theme=dark");
        url_light.setValue("https://grafana.airq.tech/d/cxkEBdtGk/tina-mobile?orgId=1&refresh=5s&from=now-1h&to=now&kiosk&theme=light");


        doc = db.collection("prediction").document("tina");
