...
public class GeorgeFragment extends Fragment {
    private GeorgeViewModel georgeViewModel;

    public View onCreateView(@NonNull LayoutInflater inflater,
                             ViewGroup container, Bundle savedInstanceState) {
        georgeViewModel =
                new ViewModelProvider(this).get(GeorgeViewModel.class);
        View root = inflater.inflate(R.layout.george_fragment, container, false);
        ...
        webview1= (WebView) root.findViewById(R.id.iframe_george);
        ...
        switch (nightModeFlags) {
            case Configuration.UI_MODE_NIGHT_YES:
                georgeViewModel.getUrl().observe(getViewLifecycleOwner(), new Observer<String>() {
                    @Override
            ...
            case Configuration.UI_MODE_NIGHT_NO:
                georgeViewModel.getLight().observe(getViewLifecycleOwner(), new Observer<String>() {
                    @Override
                    public void onChanged(@Nullable String s) {
                        webview1.loadUrl(s);
                        webview1.setWebViewClient(new WebViewClient());
        ...
        georgeViewModel.getKnn().observe(getViewLifecycleOwner(), new Observer<String>() {
            @Override
        ...
        georgeViewModel.getSvm().observe(getViewLifecycleOwner(), new Observer<String>() {
            @Override
            public void onChanged(String s) {
                tVSvm.setText("Svm : " + s);
                System.out.println(s);
        ...
        georgeViewModel.getPre().observe(getViewLifecycleOwner(), new Observer<String>() {
            @Override
            public void onChanged(String s) {
